...
import { Copy, ExternalLink, Server, FileCode, BookOpen, Code, Lock, Shield, ArrowLeft } from "lucide-react";
...
const ApiDocsPage = () => {
  ...
  return (
    <>
      <Header showBack={true} onBackClick={handleGoBack} title="واجهة برمجة التطبيقات (API)" />
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-2">
                      <Button 
                        ...
                        onClick={() => {
                          setApiKey(`sk-live-${Math.random().toString(36).substring(2, 15)}-${Math.random().toString(36).substring(2, 15)}`);
                      ...
                      <Button 
                        variant="destructive" 
                        className="w-full md:w-auto"
                        onClick={() => toast.success("تم إلغاء تنشيط المفتاح الحالي")}
                      >
