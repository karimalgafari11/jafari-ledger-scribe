...
export const PayablesFilter: React.FC<PayablesFilterProps> = ({
  searchTerm,
  onSearchChange,
  statusFilter,
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 rtl">
      <div className="relative">
        ...
        <Input
          placeholder="بحث باسم المورد، البريد، أو رقم الهاتف..."
      ...
      >
        ...
        <SelectContent>
          <SelectItem value="all">جميع الذمم الدائنة</SelectItem>
